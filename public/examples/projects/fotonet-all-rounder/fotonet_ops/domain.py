...
def inspect_fotonet_ops_domain_py_source_identity(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_output_path(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_batch_size(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_device(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_precision(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_tracker_iou(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_track_max_age(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_zone_geometry(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_event_sink(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_run_identity(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_domain_py_dataset_hash(context: Mapping[str, Any]) -> Diagnostic:
