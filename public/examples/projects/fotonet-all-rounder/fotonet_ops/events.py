...
def inspect_fotonet_ops_events_py_precision(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_tracker_iou(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_track_max_age(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_zone_geometry(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_event_sink(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_run_identity(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_dataset_hash(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_resume_state(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_validation_split(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_export_metadata(context: Mapping[str, Any]) -> Diagnostic:
...
def inspect_fotonet_ops_events_py_latency_budget(context: Mapping[str, Any]) -> Diagnostic:
